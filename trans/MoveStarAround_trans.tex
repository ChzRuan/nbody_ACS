...
\draw[anchor=north] (midpoint) node [fill=orange,fill opacity=0.1,text opacity=1, inner sep=1.9cm]{\Huge\centering\parbox[c][][t]{\paperwidth}{\bf \centering \zihao{-0} \quad \quad \quad \quad 星间漫步\\[1pt] % Book title
{\bf \zihao{3} \quad \quad \quad \quad \quad \quad \quad \quad 原著：Piet Hut $\&$ Jun Makino}\\[1pt] % Author name
{\bf \zihao{3} \quad \quad \quad \quad \quad \quad \quad \quad \quad \chntoday}
}};
\end{tikzpicture}};
\end{tikzpicture}
\vfill
